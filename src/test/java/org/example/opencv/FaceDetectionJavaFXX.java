...
public class FaceDetectionJavaFXX extends Application {
    ...
    public WritableImage capureFrame() {
        ...
        if (capture.read(matrix)) {
            ...
            final String file = Objects.requireNonNull(this.getClass().getResource("/lbpcascades/lbpcascade_frontalface.xml")).getPath();
    ...
    public void saveImage() {
        // Saving it again
        Imgcodecs.imwrite("facedetected.jpg", matrix);
    }
